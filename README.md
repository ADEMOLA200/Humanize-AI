...
**Humanize AI** is a text rewriting and humanization service that leverages advanced paraphrasing models and customizable rewriting transformations, you can visit the frontend site with the [Humanize AI](link https://humanize-ai-frontend.vercel.app). The goal is to generate text that preserves meaning while making it less detectable as machine-generated by AI detectors. The system consists of two main components:
...
### 3. Kindly visit [Humanize-AI-Server](https://github.com/ADEMOLA200/Humanize-AI-Server) to continue with the rest of the installations. 
...
#### Paraphrase Service (Python/Flask) From [Humanize-AI-Server](https://github.com/ADEMOLA200/Humanize-AI-Server).
